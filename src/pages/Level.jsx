              ...
              {state.currentQuestion !== null && (
                <>
                  <div className="flex flex-col place-items-center w-screen h-2/3">
                    <div className="bg-white w-10/12 h-1/4 mb-4 p-5">
                    ...
                    <div className="flex relative flex-row h-2/3 w-screen">
                      ...
                      <div className="absolute bg-white w-64 h-full inset-y-0 right-40 rounded-lg"></div>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-row h-1/4 w-screen place-content-center px-10">
                    {JSON.parse(state.currentQuestion.choice1).v !== null && (
                      <button
                        id="button1"
                        className="w-1/4 h-30 rounded-xl m-3 bg-white p-5"
                        onClick={() =>
                          handleChoiceClick(
                    ...
                    {JSON.parse(state.currentQuestion.choice2).v !== null && (
                      <button
                        id="button2"
                        className="w-1/4 h-30 rounded-xl m-3 bg-white"
                        onClick={() =>
                          handleChoiceClick(
                            state.currentQuestion,
