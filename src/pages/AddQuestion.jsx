  ...
  return (
    <div className="flex flex-col w-screen h-screen bg-stone-bg bg-cover">
      ...
      <div className="flex bg-white w-full h-full p-10">
        <form className="flex flex-col w-full h-full gap-10">
          <div className="flex flex-row w-full gap-5">
            <div className="flex grow relative min-w-[200px]">
              <select className="peer h-20 w-full rounded-[7px] border-2 border-black-400 border-t-transparent bg-transparent px-3 py-2.5 font-sans text-sm font-normal text-blue-gray-700 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-200 placeholder-shown:border-t-blue-gray-200 empty:!bg-gray-900 focus:border-2 focus:border-gray-900 focus:border-t-transparent focus:outline-0 disabled:border-0 disabled:bg-blue-gray-50">
                <option value="L1">
          ...
          <div className="flex flex-row w-full">
            ...
            <div class="flex grow relative h-10 w-72 min-w-[200px]">
